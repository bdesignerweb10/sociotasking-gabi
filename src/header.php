...
<head>
	...
	<meta name="description" content="SócioTasking - Gabrielle">
	<meta name="keywords" content="Sócio, Tasking, Marketing, Redes, Sociais">
	<meta name="author" content="Bruno Gomes">
	<meta name="robots" content="index, follow">
	<meta name="googlebot" content="index, follow">
	<title>SócioTasking - Gabrielle</title>
...
<body>
	<header class="header">
		<nav class="navbar navbar-expand-lg navbar-light">
			<a class="navbar-brand" href="index.php"><img src="img/logo-sociotasking.png" width="235"></a>
			...
			<div class="collapse navbar-collapse nav-menu" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="sociotasking.php">O que é SócioTasking</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="profile.php">Conheça a Gabrielle</a>
					</li>
					<li class="nav-item active nav-profile">
						<a class="nav-link" href="#">Você foi indicado por <strong>Gabrielle Viero</strong> 
